...
.method public static final F(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0}, Lc7/h;->G(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lc7/h;->E(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static final G(Ljava/util/Collection;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final H(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {v0}, La4/i0;->u(I)I

    move-result v0

    invoke-direct {v1, v0}, Ljava/util/LinkedHashSet;-><init>(I)V

    invoke-static {p0, v1}, Lc7/h;->E(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/Collection;
    ...
    invoke-static {v1, p0}, Lp2/n0;->g(Ljava/lang/Object;Ljava/lang/String;)V
