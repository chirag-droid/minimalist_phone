...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;I)V
    ...
    iget-object p2, p0, Lx3/k;->a:Lcom/google/android/material/textfield/TextInputLayout;
...
.method public static g(Lcom/google/android/material/textfield/b;Landroid/widget/AutoCompleteTextView;)V
    ...
    .line 2
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/material/textfield/b;->k()Z
...
.method public a()V
    ...
    .line 1
    iget-object v0, p0, Lx3/k;->b:Landroid/content/Context;
    ...
    .line 4
    iget-object v1, p0, Lx3/k;->b:Landroid/content/Context;
    ...
    .line 7
    iget-object v2, p0, Lx3/k;->b:Landroid/content/Context;
    ...
    .line 10
    invoke-virtual {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/b;->j(FFFI)Lt3/f;
    ...
    .line 11
    invoke-virtual {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/b;->j(FFFI)Lt3/f;

    move-result-object v0

    .line 12
    iput-object v3, p0, Lcom/google/android/material/textfield/b;->n:Lt3/f;
    ...
    .line 17
    :cond_0
    iget-object v1, p0, Lx3/k;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    invoke-direct {v3, p0}, Lx3/h;-><init>(Lcom/google/android/material/textfield/b;)V
    ...
    invoke-direct {v1, p0}, Lx3/h;-><init>(Lcom/google/android/material/textfield/b;)V
    ...
    invoke-direct {v1, p0}, Lx3/g;-><init>(Lcom/google/android/material/textfield/b;)V
...
.method public final i(Landroid/widget/AutoCompleteTextView;)V
    ...
    .line 3
    iget-object v3, p0, Lx3/k;->a:Lcom/google/android/material/textfield/TextInputLayout;

    invoke-virtual {v3}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lt3/f;
    ...
    .line 4
    invoke-static {p1, v4}, La4/x0;->n(Landroid/view/View;I)I
    ...
    .line 5
    invoke-static {p1, v0}, La4/x0;->n(Landroid/view/View;I)I
    ...
    .line 7
    iget-object v9, v3, Lt3/f;->l:Lt3/f$b;

    iget-object v9, v9, Lt3/f$b;->a:Lt3/i;

    .line 8
    invoke-direct {v8, v9}, Lt3/f;-><init>(Lt3/i;)V

    .line 9
    invoke-static {v4, v0, v7}, La4/x0;->s(IIF)I
    ...
    invoke-virtual {v8, v9}, Lt3/f;->q(Landroid/content/res/ColorStateList;)V

    .line 11
    invoke-virtual {v8, v0}, Lt3/f;->setTint(I)V
    ...
    .line 14
    iget-object v6, v3, Lt3/f;->l:Lt3/f$b;

    iget-object v6, v6, Lt3/f$b;->a:Lt3/i;

    .line 15
    invoke-direct {v4, v6}, Lt3/f;-><init>(Lt3/i;)V

    const/4 v6, -0x1

    .line 16
    invoke-virtual {v4, v6}, Lt3/f;->setTint(I)V
    ...
    .line 20
    invoke-static {p1, v1}, Lj0/x$d;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final j(FFFI)Lt3/f;
    .locals 4
    ...
    .line 4
    invoke-virtual {v0, p2}, Lt3/i$b;->c(F)Lt3/i$b;

    .line 5
    invoke-virtual {v0, p2}, Lt3/i$b;->d(F)Lt3/i$b;
    ...
    .line 7
    iget-object p2, p0, Lx3/k;->b:Landroid/content/Context;
    ...
    .line 11
    invoke-static {p2, v1, v0}, Lq3/b;->c(Landroid/content/Context;ILjava/lang/String;)I
    ...
    .line 13
    iget-object v2, v1, Lt3/f;->l:Lt3/f$b;

    new-instance v3, Lk3/a;

    invoke-direct {v3, p2}, Lk3/a;-><init>(Landroid/content/Context;)V

    iput-object v3, v2, Lt3/f$b;->b:Lk3/a;

    .line 14
    invoke-virtual {v1}, Lt3/f;->x()V
    ...
    invoke-virtual {v1, p2}, Lt3/f;->q(Landroid/content/res/ColorStateList;)V

    .line 16
    iget-object p2, v1, Lt3/f;->l:Lt3/f$b;

    iget v0, p2, Lt3/f$b;->o:F
    ...
    iput-object p1, p2, Lt3/f$b;->a:Lt3/i;

    .line 20
    invoke-virtual {v1}, Lt3/f;->invalidateSelf()V

    .line 21
    iget-object p1, v1, Lt3/f;->l:Lt3/f$b;

    iget-object p2, p1, Lt3/f$b;->i:Landroid/graphics/Rect;
    ...
    iput-object p2, p1, Lt3/f$b;->i:Landroid/graphics/Rect;

    .line 23
    :cond_1
    iget-object p1, v1, Lt3/f;->l:Lt3/f$b;

    iget-object p1, p1, Lt3/f$b;->i:Landroid/graphics/Rect;
